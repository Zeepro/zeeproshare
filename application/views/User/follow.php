...
<div class="content-wrapper">
	<div class="ui-grid-b ui-corner-all ui-shadow ui-transparent" style="padding: 5px;">
		...
		    <div class="ui-block-a"><a href="https://twitter.com/zeeproshare" target="_blank" data-ajax="false" data-role="button" class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-tw-icon">{twitter}</a></div>
		    <div class="ui-block-b"><a href="https://www.facebook.com/Zeepro3dprinter" target="_blank" data-ajax="false" data-role="button" class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-fb-icon">{facebook}</a></div>
		...
		    <div class="ui-block-c" style="margin-top:-20px"><a href="https://www.youtube.com/channel/UCes39gehIaKnTUGHPvywctA" target="_blank" data-ajax="false" data-role="button" class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-yt-icon">{youtube}</a></div>
		</div>
	</div>
	<script>
